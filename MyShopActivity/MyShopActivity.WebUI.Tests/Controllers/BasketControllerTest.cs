...
using MyShopActivity.Services;
using MyShopActivity.WebUI.Controllers;
using MyShopActivity.WebUI.Tests.Mocks;
...
namespace MyShopActivity.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "admin@admin.com", ZipCode = "3022" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("admin@admin.com", "Forms"), null);
